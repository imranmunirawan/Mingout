...
public class ChatAgeFromDialog extends Dialog implements
	...
	public ChatAgeFromDialog(Context context, Fragment frag) {
		super(context);
	...
	public ChatAgeFromDialog(Context context, Activity activity, TextView textView) {
		super(context);
		// TODO Auto-generated constructor stub
		this.context = context;
	...
	public void onClick(View v) {
		...
		case R.id.B_select:
			if (selectedGender != null) {
				if(fragment != null){
					((AgeFromListner) fragment).setAgeFrom(selectedGender);
				}else if(activity != null){
                    Constants.MATCHES_SETTINGS_FROM_AGE = selectedGender;
	...
	public interface AgeFromListner {
		public void setAgeFrom(String gender);
	}
}
