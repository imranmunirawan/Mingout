...
public class ServerAlertDialog extends Dialog implements
	...
	public ServerAlertDialog(Context context, String message) {
		super(context);
	...
	public ServerAlertDialog(Activity context, String message, String title) {
		super(context);
		// TODO Auto-generated constructor stub
		this.context = context;
		this.message = message;
