...
public class ProfileGalleryFragment extends Fragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.profile_gallery_frag, null);
		...
		try {
			//fragmentFlag = Constants.FRAGMENT_FLAG;
			fragmentFlag = getActivity().getIntent().getIntExtra("Fragment Flag", 1);
			getData();
		} catch (Exception e) {
	...
	private void getData() throws JSONException {
		...
		try {
			...
			new ConnectionTaskSupportFragment(ProfileGalleryFragment.this, jsonobj).execute(Constants.API_PROFILE);
