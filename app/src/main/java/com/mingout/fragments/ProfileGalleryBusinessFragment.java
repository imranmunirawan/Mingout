...
public class ProfileGalleryBusinessFragment extends Fragment implements
	...
	int CAMERA_REQUEST = 1123, PICK_IMAGE = 1211, CROP_PIC = 12288;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_profile_gallery_business_layout, null);
		...
		if (picturePlace.equals("2")) {
			if (i2ImageAvailable == null) {
				GalleryUploadImageDialog dialog = new GalleryUploadImageDialog(
						getActivity(), ProfileGalleryBusinessFragment.this);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == CAMERA_REQUEST
			...
			selectedImagee = data.getData();
			performCrop(selectedImagee);
			Toast.makeText(getActivity(), selectedImagee + "",
		...
		if (requestCode == CROP_PIC && resultCode == getActivity().RESULT_OK) {
			...
			// Only scale if the source is big enough. This code is just
			// rying
	...
	public void uploadPic() {
		...
		try {
			...
			new ConnectionTaskSupportFragment(
					ProfileGalleryBusinessFragment.this, jsonobj)
	...
	public void UpdateResult(Object obj) {
		...
		try {
			...
			((RefreshBusinessDataListner) getActivity()).refreshBusinessData();
